...
\begin{frame}{Beispiel}
	...
	\begin{figure}
		...
		\draw [myRed, ultra thick, ->, opacity=0.75, visible on=<4->] plot [smooth] coordinates{(s) (P1) (Q1) (t)};
	\end{tikzpicture}
	\end{figure}
...
\begin{frame}{Equilibrium}
	...
	\begin{itemize}
		\item<2-> $f$ ist Nashfluss im induziertem Spiel $\mathcal G^g$
		\item<3-> $g$ ist BBR zu $f$.
	\end{itemize}
